...
project also relies heaving on log analysis of Apache logs.
...
This project is under B<core development> (pre-Alpha).  It is not
even ready for assessment.

The first alpha release is expectecd in June/July 2012.
...
capability that was one of the purposed of the POD format.
...
only server, and you still have the doco there in easily readable
