...
only server, and you still have the doco there, in and easily readable
...
may not have yet hit 'standard package' delivery.  It is of note
that RedHat have included BIND 9.8.2 in their repository.  So,
manual build may not be required, depending on the Linux distro.
